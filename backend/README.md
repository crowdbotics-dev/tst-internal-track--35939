...
## Project Structure
    ...
    ├── tst_internal_track__35939  # Django project configurations
...
1. Clone this repo and `cd tst_internal_track__35939`
...
2. Clone this repo and `cd tst_internal_track__35939`
